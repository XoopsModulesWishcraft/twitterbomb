 ...
 * @access 		public
 */
class TwitterBombFormSelectType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectType($caption, $name, $value = null, $size = 1, $multiple = false, $blank=true, $options = 'bomb,scheduler,retweet,reply,mentions,pictures')
    {
