...
class TwitterbombFormCheckBoxPictures extends XoopsFormElement
{
    /**
     * Availlable options
     *
     ...
     */
    function TwitterbombFormCheckBoxPictures($caption, $name, $value = null, $delimeter = '&nbsp;')
    {
        ...
        foreach($pictures_handler->getObjects($criteria, true) as $rid => $pictures) {
        	$this->addOption($rid, $pictures->getVar('search'));
        }
    }
