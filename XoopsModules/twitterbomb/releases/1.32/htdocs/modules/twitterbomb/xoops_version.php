...
$modversion['releasedate'] = "Monday, July 09, 2012";
...
$modversion['release_info'] = "Stable 2012/07/09";
$modversion['release_file'] = XOOPS_URL."/modules/twitterbomb/docs/changelog.txt";
$modversion['release_date'] = "2012/07/09";
...
$modversion['tables'][13] = "twitterbomb_pictures";
...
$modversion['templates'][30]['file'] = 'twitterbomb_cpanel_pictures_edit.html';
$modversion['templates'][30]['description'] = 'Main Control Panel Twitter Bomb Pictures Edit';
$modversion['templates'][31]['file'] = 'twitterbomb_cpanel_pictures_list.html';
$modversion['templates'][31]['description'] = 'Main Control Panel Twitter Bomb Pictures List';
...
$i++;
$modversion['config'][$i]['name'] = 'pictures_items';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_PICTURES_ITEMS";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_PICTURES_ITEMS_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 5;
...
$i++;
$modversion['config'][$i]['name'] = 'pictures_cache';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_PICTURES_CACHE";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_PICTURES_CACHE_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 60*45;
...
$modversion['config'][$i]['options'] = array(_MI_TWEETBOMB_TREND_CURRENT => 'current', _MI_TWEETBOMB_TREND_DAILY => 'daily', _MI_TWEETBOMB_TREND_WEEKLY => 'weekly');
...
$i++;
$modversion['config'][$i]['name'] = 'cron_pictures';
$modversion['config'][$i]['title'] = '_MI_TWEETBOMB_CRON_PICTURES';
$modversion['config'][$i]['description'] = '_MI_TWEETBOMB_CRON_PICTURES';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = true;
$modversion['config'][$i]['options'] = 	array();
...
$i++;
$modversion['config'][$i]['name'] = 'pictures_per_session';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_PICTURES_PER_SESSION";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_PICTURES_PER_SESSION_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 10;
...
$i++;
$modversion['config'][$i]['name'] = 'sentence_max_len';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_SENTENCE_MAXIMUM_LENGHT";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_SENTENCE_MAXIMUM_LENGHT_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 122;

$i++;
$modversion['config'][$i]['name'] = 'myalbum_dirname';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_MYALBUMP_DIRNAME";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_MYALBUMP_DIRNAME_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = 'myalbum';

$i++;
$modversion['config'][$i]['name'] = 'myalbum_status';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_MYALBUMP_STATUS";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_MYALBUMP_STATUS_DESC";
$modversion['config'][$i]['formtype'] = 'select';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 0;
$modversion['config'][$i]['options'] = array(_MI_TWEETBOMB_MYALBUMP_STATUS_UNAPPROVED=>0,_MI_TWEETBOMB_MYALBUMP_STATUS_APPROVED=>1);
?>
