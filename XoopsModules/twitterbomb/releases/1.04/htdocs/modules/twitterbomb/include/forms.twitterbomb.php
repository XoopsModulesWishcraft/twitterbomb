<?php
	...
	function tweetbomb_campaign_get_form($object) {
		...
		$ele['start'] = new XoopsFormTextDateSelect(_AM_TWEETBOMB_FORM_START_CAMPAIGN, $id.'[start]', $object->getVar('start'));
		$ele['start']->setDescription(_AM_TWEETBOMB_FORM_DESC_START_CAMPAIGN);
		$ele['end'] = new XoopsFormTextDateSelect(_AM_TWEETBOMB_FORM_END_CAMPAIGN, $id.'[end]', $object->getVar('end'));
