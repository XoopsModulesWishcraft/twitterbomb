...
class XoopsFormSelectCampaigns extends XoopsFormElement
{
     ...
     */
    function XoopsFormSelectCampaigns($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
		...
		@$this->GetCampaign($ownid);
    }

	function GetCampaign($ownid){
		...
		$crtieria = new CriteriaCompo($criteriaa, 'OR');
		$crtieria->add($criteriab, 'OR');
