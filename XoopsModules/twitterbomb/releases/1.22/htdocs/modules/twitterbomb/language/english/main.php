<?php
	...
	// Version 1.11
	// RSS Help Defined
	define('_MN_TWEETBOMB_RSS_TIMED_TITLE', 'Scheduled Campaign between %s and %s');
	define('_MN_TWEETBOMB_RSS_TIMED_DESCRIPTION', 'This campaign has timed out and is no longer running, the Scheduled Campaign ran between the starting date of %s and ended on the %s.');

	// Version 1.12
	//Form Definitions
	define('_MN_TWEETBOMB_FORM_TYPE_USERNAMES', 'Type of Username');
	define('_MN_TWEETBOMB_FORM_DESC_TYPE_USERNAMES', '');
	define('_MN_TWEETBOMB_FORM_NICK_USERNAMES', 'Source nickname or phrase');
	define('_MN_TWEETBOMB_FORM_DESC_NICK_USERNAMES', '<em>(Only valid with a \'scheduler type of username\')</em>');
