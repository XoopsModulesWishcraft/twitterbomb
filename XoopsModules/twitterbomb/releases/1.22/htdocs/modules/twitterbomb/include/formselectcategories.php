 ...
 * @access 		public
 */
class TwitterBombFormSelectCategories extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectCategories($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
