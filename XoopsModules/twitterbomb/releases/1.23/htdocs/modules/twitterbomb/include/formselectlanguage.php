...
class TwitterBombFormSelectLanguage extends XoopsFormElement
{
     ...
     */
    function TwitterBombFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
