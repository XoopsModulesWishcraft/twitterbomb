 ...
 * @access 		public
 */
class TwitterBombFormSelectMeasurement extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectMeasurement($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('mi' => 'Miles', 'km' => 'Kilometers') as $key=>$measurement)
			$this->addOption($key, (defined('_MI_TWEETBOMB_MEASUREMENT_'.strtoupper($key))?constant('_MI_TWEETBOMB_MEASUREMENT_'.strtoupper($key)):$measurement));
    }
