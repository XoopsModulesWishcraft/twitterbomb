...
$modversion['releasedate'] = "Monday: August 29, 2011";
...
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_RETWEETS_ODDS_LOWER_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 0;
...
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_RETWEETS_ODDS_HIGHER_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 10;
$i++;
...
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_RETWEETS_ODDS_MINIMUM_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
...
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_RETWEETS_ODDS_MAXIMUM_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
