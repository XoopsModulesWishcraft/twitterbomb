...
if ($xoConfig['cron_tweet']) {
	...
	while ($c<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)&&$loopsb<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)*1.75&&$campaignCount>0) {
		$loopsb++;
		$cids=array();
		foreach($campaigns as $cid => $campaign) {
			...
			if ($c<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)) {
				$campaign->setCron();
				switch($campaign->getVar('type')) {
					case "bomb":
						...
						$ret = array();
						$loop=0;
						while((((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['items']))>$items&&$c<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)&&(((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['items']))*2>$loop) {
					...
					case "scheduler":
						...
						$loop=0;
						$item=0;
						while((((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['scheduler_items']))>$items&&$c<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)&&(((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['scheduler_items']))*2>$loop) {
					...
					case "retweet":
						...
						$loop=0;
						$item=0;
						while((((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['retweet_items']))>$items&&$c<=(($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)&&(((($xoConfig['tweets_per_session']+$xoConfig['retweets_per_session'])/2)/$campaignCount)*(($xoConfig['items']+$xoConfig['scheduler_items']+$xoConfig['retweet_items'])/$xoConfig['retweet_items']))*2>$loop) {
