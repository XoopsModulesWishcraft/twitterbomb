 ...
 * @access 		public
 */
class TwitterBombFormSelectLogType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectLogType($caption, $name, $value = null, $size = 1, $multiple = false, $blank=true)
    {
        ...
        foreach(array('bomb','scheduler','retweet') as $mode)
