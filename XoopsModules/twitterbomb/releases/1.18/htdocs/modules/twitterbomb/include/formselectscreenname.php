 ...
 * @access 		public
 */
class TwitterBombFormSelectScreenname extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectScreenname($caption, $name, $value = null, $size = 1, $multiple = false, $blank=true, $ids = null)
    {
