 ...
 * @access 		public
 */
class XoopsFormSelectCategories extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectCategories($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
	...
	function GetCategories($ownid){
		...
		$categories = $category_handler->getObjects(new Criteria('pcatid', 0), true);
	...
	function TreeMenu($langs_array, $categories, $level, $ownid) {
		...
		foreach($categories as $catid => $category) {
			if ($catid!=$ownid) {
				...
				if ($categoriesb = $category_handler->getObjects(new Criteria('pcatid', $catid), true)){
