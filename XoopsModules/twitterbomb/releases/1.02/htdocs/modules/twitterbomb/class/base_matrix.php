...
class TwitterbombBase_matrix extends XoopsObject
{
    ...
    function TwitterbombBase_matrix($fid = null)
    {
		...
		$this->initVar('base1', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));    
		$this->initVar('base2', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
		$this->initVar('base3', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
		$this->initVar('base4', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
		$this->initVar('base5', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
		$this->initVar('base6', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
		$this->initVar('base7', XOBJ_DTYPE_ENUM, null, false, false, false, array('for','when','clause','then','over','under','their','there',''));
	...
	function toArray() {
		...
		$ele['base3'] = new XoopsFormSelectBase('', $ret['baseid'].'[base3]', $this->getVar('base3'));
		$ele['base4'] = new XoopsFormSelectBase('', $ret['baseid'].'[base4]', $this->getVar('base4'));
		$ele['base5'] = new XoopsFormSelectBase('', $ret['baseid'].'[base5]', $this->getVar('base5'));
		$ele['base6'] = new XoopsFormSelectBase('', $ret['baseid'].'[base6]', $this->getVar('base6'));
		$ele['base7'] = new XoopsFormSelectBase('', $ret['baseid'].'[base7]', $this->getVar('base7'));
		if ($ret['uid']>0) {
	...
	function runInsertPlugin() {
		...
		include_once($GLOBALS['xoops']->path('/modules/twitterbomb/plugin/'.strtolower($this->getPopulatedBaseCode()).'.php'));
...
class TwitterbombBase_matrixHandler extends XoopsPersistableObjectHandler
{
    ...
    function getSentence($cid, $catid) {
