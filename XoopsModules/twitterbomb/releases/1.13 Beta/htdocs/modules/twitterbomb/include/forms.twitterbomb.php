<?php
	...
	function tweetbomb_base_matrix_get_form($object) {
		...
		$ele['base1'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEA_BASEMATRIX, $id.'[base1]', $object->getVar('base1'));
		$ele['base1']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASEA_BASEMATRIX);
		$ele['base2'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEB_BASEMATRIX, $id.'[base2]', $object->getVar('base2'));
		$ele['base2']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASEB_BASEMATRIX);
		$ele['base3'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEC_BASEMATRIX, $id.'[base3]', $object->getVar('base3'));
		$ele['base3']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASEC_BASEMATRIX);
		$ele['base4'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASED_BASEMATRIX, $id.'[base4]', $object->getVar('base4'));
		$ele['base4']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASED_BASEMATRIX);
		$ele['base5'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEE_BASEMATRIX, $id.'[base5]', $object->getVar('base5'));
		$ele['base5']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASEE_BASEMATRIX);
		$ele['base6'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEF_BASEMATRIX, $id.'[base6]', $object->getVar('base6'));
		$ele['base6']->setDescription(_AM_TWEETBOMB_FORM_DESC_BASEF_BASEMATRIX);
		$ele['base7'] = new TwitterBombFormSelectBase(_AM_TWEETBOMB_FORM_BASEG_BASEMATRIX, $id.'[base7]', $object->getVar('base7'));
