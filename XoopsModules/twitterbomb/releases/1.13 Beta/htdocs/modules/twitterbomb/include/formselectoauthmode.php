 ...
 * @access 		public
 */
class TwitterBombFormSelectOAuthMode extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TwitterBombFormSelectOAuthMode($caption, $name, $value = null, $size = 1, $multiple = false, $blank=true)
    {
        ...
        foreach(array('valid','invalid','expired','disabled','other') as $mode)
			$this->addOption($mode, (defined('_MI_TWEETBOMB_OAUTH_MODE_TITLE_'.strtoupper($mode))?constant('_MI_TWEETBOMB_OAUTH_MODE_TITLE_'.strtoupper($mode)):'define '.'_MI_TWEETBOMB_OAUTH_MODE_TITLE_'.strtoupper($mode)));
    }
