...
$modversion['releasedate'] = "Thursday: August 11, 2011";
...
$i++;
$modversion['config'][$i]['name'] = 'runtime_of_cron';
$modversion['config'][$i]['title'] = "_MI_TWEETBOMB_RUNTIME_OF_CRON";
$modversion['config'][$i]['description'] = "_MI_TWEETBOMB_RUNTIME_OF_CRON_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 59;
