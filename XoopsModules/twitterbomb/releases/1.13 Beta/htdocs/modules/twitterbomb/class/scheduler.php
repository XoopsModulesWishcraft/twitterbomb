...
class TwitterbombSchedulerHandler extends XoopsPersistableObjectHandler
{
    ...
    function getTweet($cid='0', $catid='0', $when='0', $tweeted='0') {
    	...
    	$criteria->add(new Criteria('`when`', $when, ($GLOBALS['xoopsModuleConfig']['crontype']!='rss'?'<>':'=')), 'AND');
    	$criteria->add(new Criteria('`tweeted`', $tweeted, ($GLOBALS['xoopsModuleConfig']['crontype']!='rss'?'<>':'=')), 'AND');
    ...
    function getFilterForm($filter, $field, $sort='sid') {
