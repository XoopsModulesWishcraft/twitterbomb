<?php
	...
	if (is_object($GLOBALS['twitterbombModule'])) {
		...
		define('_MI_TWEETBOMB_TITLE_ADMENU10','Preferences');
		define('_MI_TWEETBOMB_ICON_ADMENU10','../../'.$GLOBALS['twitterbombModule']->getInfo('icons32').'/twitterbomb.preferences.png');
		define('_MI_TWEETBOMB_LINK_ADMENU10','../system/admin.php?fct=preferences&op=showmod&mod='.$GLOBALS['twitterbombModule']->getVar('mid'));
